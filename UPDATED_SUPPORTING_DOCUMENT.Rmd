...
### Example: Exercise 01 - Level of Measurement
...
- Complete definitions provided directly in feedback
- Clear examples with crime data: "Soort misdrijf" as nominal variable
- Visual classification guides explaining why options are correct/incorrect
...
### Example: Exercise 08 - Standard Deviation Calculation
...
**Assessment Strategy:** Manual calculation with tolerance for rounding

**Scaffolding Features:**
- Step-by-step calculation guide provided
- Formula breakdown with variable definitions
- Error-specific feedback for common mistakes

**Sample Error Detection:**
```r
if (abs(student_answer - sample_sd) < 0.01) {
  feedback <- "❌ Je hebt de steekproef-SD berekend (n-1). 
               Voor populatie-SD gebruik n in de noemer."
}
```
...
### Example: Exercise 13 - t-Test Calculation
...
**Expected Answer:** 5.51 (with ±0.05 tolerance)

**Scaffolding Features:**
- Formula references provided
- Step-by-step verification in detailed feedback
- Multiple error patterns identified with specific guidance

## Evaluation Level: Evaluate (Exercises 16-19)

### Example: Exercise 19 - Spurious Correlation Detection
**Learning Objective:** Students distinguish correlation from causation
**Criminological Context:** Third variable effects in crime relationships
**Assessment Strategy:** Multiple choice with critical thinking prompts

**Scaffolding Features:**
- Framework for evaluation without giving away answers
- Critical thinking prompts about alternative explanations
- Policy implications discussed in feedback

## Creation Level: Create (Exercise 20)

### Example: Exercise 20 - Research Design Creation
...
**Scaffolding Features:** Basic framework templates only, minimal guidance
